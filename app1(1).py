...
tokenizer = BertTokenizer.from_pretrained('G:/python/Lib/site-packages/bert-base-chinese') 
model=TFBertModel.from_pretrained('G:/python/Lib/site-packages/bert-base-chinese')
